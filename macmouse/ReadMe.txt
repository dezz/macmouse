================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: macmouse プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した macmouse には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには macmouse アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
macmouse.h
   ...
   MacMouseApp アプリケーション クラスを宣言します。

macmouse.cpp
   これは、アプリケーション クラス MacMouseApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\macmouse.ico
   ...
   アイコンはメイン リソース ファイル macmouse.rc に含まれていま
   す。
...
MacMouseDlg.h, MacMouseDlg.cpp - ダイアログ
   これらのファイルは MacMouseDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な macmouse.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   macmouse.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
